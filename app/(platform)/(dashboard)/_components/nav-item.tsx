    ...
    const routes = [
        {
            ...
            href: `/organisation/${organization.id}`
        },
        {
            label: "Activity",
            icon: <Activity className="size-4 mr-2" />,
            href: `/organisation/${organization.id}/activity`
        },
        {
            label: "Settings",
            icon: <Settings className="size-4 mr-2" />,
            href: `/organisation/${organization.id}/settings`
        },
        {
            label: "Billing",
            icon: <CreditCard className="size-4 mr-2" />,
            href: `/organisation/${organization.id}/billing`
        },
    ]
        ...
        >
            ...
            >
                <div className="flex items-center gap-x-2">
                    ...
                    <span className="font-mediums text-sm">
                        {organization.name}
                    </span>
                </div>
